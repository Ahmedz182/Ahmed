        ...
        <div className="relative w-full h-screen flex bg-theme-dark overflow-hidden font-sans text-white">
            ...
            <div className="hidden lg:flex w-1/2 relative z-10 flex-col items-start justify-center p-10 xl:p-16 border-r border-white/5 h-full">
                ...
                >
                    ...
                    <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 shadow-[0_0_30px_rgba(51,214,159,0.15)] flex items-center justify-center text-accent-mint mb-6">
                        <ShieldCheck className="w-7 h-7" />
                    </div>

                    <h1 className="text-4xl xl:text-5xl font-black tracking-tight mb-4">
                        Ahmed Fayyaz <br />
